...
RIM_MAP: dict[tuple[str, str], float] = {
    ...
    ("HARLEY-DAVIDSON", "UNKNOWN"):    0,
    ("HARLEY-DAVIDSON", "FXD SERIES"): 0,
    ("HARLEY-DAVIDSON", "FXS SERIES"): 0,
    ("HARLEY-DAVIDSON", "FLH SERIES"): 0,
    ("HARLEY-DAVIDSON", "CRU SERIES"): 0,
    ("HARLEY-DAVIDSON", "XL SERIES"):  0,
    ("HARLEY-DAVIDSON", "VRSCF"):      0,
    # ── More legacy + engine-variant models from round 2 ──────
    # Lexus engine variants (BITRE stores IS250 / RX350 as separate
    # models — same rim as the platform-level entry).
    ("LEXUS", "IS250"): 17,
    ("LEXUS", "IS300"): 17,
    ("LEXUS", "IS350"): 18,
    ("LEXUS", "RX300"): 18,
    ...
    ("VOLKSWAGEN", "JETTA"): 16,
    ("VOLKSWAGEN", "T-ROC"): 17,
    ("VOLKSWAGEN", "TOURAN"): 16,
    ("VOLKSWAGEN", "SCIROCCO"): 17,
    ("VOLKSWAGEN", "EOS"): 17,
    ("VOLKSWAGEN", "BEETLE"): 16,
    # Hyundai / Kia sport-ish variants
    ("HYUNDAI", "VELOSTER"): 17,
    ("HYUNDAI", "GENESIS"): 18,
    ("HYUNDAI", "TERRACAN"): 17,
    ("KIA", "GRAND CARNIVAL"): 17,
    ("KIA", "MAGENTIS"): 17,
    ("KIA", "SPECTRA"): 15,
    ("KIA", "PREGIO"): 15,
    # Toyota legacy
    ("TOYOTA", "ESTIMA"): 16,
    ("TOYOTA", "AVALON"): 16,
    ("TOYOTA", "TARAGO CAMRY"): 15,
    ("TOYOTA", "CRESSIDA"): 14,
    ("TOYOTA", "CALDINA"): 15,
    ("TOYOTA", "SUPRA"): 19,
    ("TOYOTA", "RUKUS"): 17,
    # Mitsubishi legacy
    ("MITSUBISHI", "EXPRESS"): 15,
    ("MITSUBISHI", "CHALLENGER"): 17,
    ("MITSUBISHI", "GRANDIS"): 16,
    ("MITSUBISHI", "COLT"): 15,
    ("MITSUBISHI", "380"): 17,
    ("MITSUBISHI", "GALANT"): 16,
    ...
    ("NISSAN", "ELGRAND"):   17,
    ("NISSAN", "PRESAGE"):   16,
    # Holden legacy engine variants + luxury tier
    ("HOLDEN", "CAPRICE"):    17,
    ("HOLDEN", "TORANA"):     14,
    ("HOLDEN", "KINGSWOOD"):  14,
    ("HOLDEN", "PREMIER"):    14,
    ...
    ("FORD", "SPECTRON"):  14,
    ("FORD", "TELSTAR"):   14,
    # Peugeot / Renault / Citroen legacy
    ("PEUGEOT", "206"):   15,
    ("PEUGEOT", "207"):   15,
    ("PEUGEOT", "208"):   15,
    ("PEUGEOT", "307"):   16,
    ...
    # Chrysler / Dodge
    ("CHRYSLER", "300C"):   18,
    ("CHRYSLER", "GRAND VOYAGER"): 17,
    ("CHRYSLER", "SEBRING"): 16,
    ("CHRYSLER", "PT CRUISER"): 15,
    ("DODGE", "JOURNEY"):   17,
    ("DODGE", "CALIBER"):   16,
    # Suzuki other
    ("SUZUKI", "APV"):   14,
